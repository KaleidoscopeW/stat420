...
- Your assignment must be submitted through the [submission link](https://compass2g.illinois.edu/webapps/assignment/uploadAssignment?content_id=_4279952_1&course_id=_49160_1&group_id=&mode=cpview) on **Compass 2g.** You are required to attach one `.zip` file, named `hw05_yourNetID.zip`, which contains:
    - Your RMarkdown file which should be saved as `hw05_yourNetID.Rmd`. For example `hw05_rqzhu.Rmd`.
    - The result of knitting your RMarkdown file as `hw05_yourNetID.html`. For example `hw05_rqzhu.html`.
